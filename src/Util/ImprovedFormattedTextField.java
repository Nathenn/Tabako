...
public class ImprovedFormattedTextField extends JFormattedTextField {
	...
	private static final long serialVersionUID = 1926814392049243851L;
  ...
  public ImprovedFormattedTextField( Format aFormat ) {
    ...
    setBackground(new Color(150,240,170,70));
  ...
  public void updateUI() {
    super.updateUI();
    fBackground = new Color(150,240,170,70);
    fForeground = Color.BLACK;
  }

  private boolean validContent() {

	if(getText()=="" || getText().isEmpty()) return true; //ha uj ures cellba kattintok Enterre lehessen tovabbmenni
